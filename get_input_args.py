...
def get_input_args():
    ...
    """
        argparse Module is a built in Module in Python which make it easy to handle with command line Interface
        argparse ---> [ ArgumentParser() {Method} ---> add_argument( name or flags...[, action][, nargs][, const][, default][, type][, choices][, required][, help][, metavar][, dest])]
    """
